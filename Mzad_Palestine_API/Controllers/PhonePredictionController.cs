...
namespace Mzad_Palestine_API.Controllers
{
    ...
    {
        private readonly IPhonePredictionService _predictionService;

        public PhonePredictionController(IPhonePredictionService predictionService)
        {
            _predictionService = predictionService;
        }

        [HttpPost("predict")]
        public async Task<IActionResult> PredictPrice([FromBody] PhonePredictionRequestDto request)
        {
